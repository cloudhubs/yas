...
public class SecurityProperties {
    ...
    public List<String> getCsrfIgnored() { return csrfIgnored; }
    public void setCsrfIgnored(List<String> csrfIgnored) { this.csrfIgnored = csrfIgnored; }
    ...
    public static class Rule {
        ...
        private boolean authenticated = false; // <-- NEW FIELD
